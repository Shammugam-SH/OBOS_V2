                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Monthly Purchase
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="dataAnalysisPeriodSalesMonth">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisPeriodSalesMonth').load('controllerProcessDataAnalysis/dataAnalysisPeriodicSalesGetByMonth.php');
