...
?>
<br>
<table class="table table-bordered" id="pendingOrderManagementPageGetDetailsTable" width="100%" cellspacing="0">
    <thead>
        <tr>
            <th>NO</th>
            <th>PRODUCT ID</th>
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>";
                echo "<input type='hidden' id='pendingOrderManagementPageGetDetailsTableHiddenInput' name='newOrderManagementPageTableHiddenInput' value='" . $longUserData . "' readonly>";
                echo "<td>" . $num . "</td>";
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#pendingOrderManagementPageGetDetailsTable').DataTable({
            "language": {
