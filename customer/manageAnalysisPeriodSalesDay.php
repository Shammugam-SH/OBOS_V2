                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Daily Purchase
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="dataAnalysisPeriodSalesDay">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisPeriodSalesDay').load('controllerProcessDataAnalysis/dataAnalysisPeriodicSalesGetByDay.php');
