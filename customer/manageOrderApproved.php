                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Approved Order Management Page
                            </div>
                            <div class="card-body">

                                <div id="approvedOrderManagementPageHolder">

                                    <div id="approvedOrderManagementPageMainDiv">
                                    </div>
                                    <div class="table-responsive" id="approvedOrderManagementPageTableDiv">
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#approvedOrderManagementPageTableDiv').load('controllerProcessManageOrder/approvedOrderManagementPageTable.php');
