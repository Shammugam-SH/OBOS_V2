                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Pending Order Management Page
                            </div>
                            <div class="card-body">

                                <div id="pendingOrderManagementPageHolder">

                                    <div id="pendingOrderManagementPageMainDiv">
                                    </div>
                                    <div class="table-responsive" id="pendingOrderManagementPageTableDiv">
                                    </div>
