                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Yearly Purchase
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="dataAnalysisPeriodSalesYear">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisPeriodSalesYear').load('controllerProcessDataAnalysis/dataAnalysisPeriodicSalesGetByYear.php');
