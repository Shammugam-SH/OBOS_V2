                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Order Product Page
                            </div>
                            <div class="card-body">

                                <div id="orderProductPageHolder">

                                    <div id="orderProductPageMainDiv">
                                    </div>

                                    <hr>

                                    <div class="table-responsive" id="orderProductPageProductDiv">
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#orderProductPageMainDiv').load('controllerProcessOrderProduct/orderProductPageMain.php');
        $('#orderProductPageProductDiv').load('controllerProcessOrderProduct/orderProductPageProducts.php');
