                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i>  Product Sales Page (Price) 
                            </div>
                            <div class="card-body">

                                <div id="dataAnalysisProductSalesManagementPageSales">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisProductSalesManagementPageSales').load('controllerProcess/manageAnalysisProductSalesGetData.php');
