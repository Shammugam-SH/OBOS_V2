                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Customer Management Page</div>
                            <div class="card-body">

                                <div id="customerManagementPageHolder">

                                    <div id="customerManagementPageMainDiv">
                                    </div>
                                    <div class="table-responsive" id="customerManagementPageTableDiv">
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#customerManagementPageMainDiv').load('customerManagementPageMain.php');
