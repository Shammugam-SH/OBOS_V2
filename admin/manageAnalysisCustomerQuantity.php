                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i>  Customer Sales Page (Quantity) 
                            </div>
                            <div class="card-body">

                                <div id="dataAnalysisCustomerSalesManagementPageQuantity">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisCustomerSalesManagementPageQuantity').load('controllerProcess/manageAnalysisCustomerQuantityGetData.php');
