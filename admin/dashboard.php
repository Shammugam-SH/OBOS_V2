            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12" style="text-align: center;">
                        <hr>
                        <h1 style="">Administrator Dashboard</h1>
                        <p>
                            This is the main page for the administrator to manage the system...
                            <br>
                            There are few module available for the administrator to manage the system...
                            <br>
                        ...
                        <div class="col-xl-12 col-sm-6 mb-3">
                            <div class="card text-white bg-primary o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><strong>MANAGE CUSTOMERS</strong></div>
                                </div>
                                <a class="card-footer text-white clearfix small z-1" href="manageCustomer.php">
                                    <span class="float-left"><strong>You can manage the customers data using this menu...</strong></span>
                        ...
                        <div class="col-xl-12 col-sm-6 mb-3">
                            <div class="card text-white bg-warning o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5"><strong>MANAGE PRODUCTS</strong></div>
                                </div>
                                <a class="card-footer text-white clearfix small z-1" href="manageProduct.php">
                                    <span class="float-left"><strong>You can manage the products data using this menu...</strong></span>
                                    <span class="float-right">
                                        <i class="fa fa-angle-right"></i>
                                    </span>
                                </a>
                        ...
                        <div class="col-xl-12 col-sm-6 mb-3">
                            <div class="card text-white bg-success o-hidden h-100">
                                ...
                                <a class="card-footer text-white clearfix small z-1" href="manageOrderNew.php">
                                    <span class="float-left"><strong>You can manage the orders data using this menu...</strong></span>
                                    <span class="float-right">
                                        <i class="fa fa-angle-right"></i>
                                    </span>
                                </a>
                        ...
                        <div class="col-xl-12 col-sm-6 mb-3">
                            <div class="card text-white bg-danger o-hidden h-100">
                                ...
                                <a class="card-footer text-white clearfix small z-1" href="manageAnalysisSummary.php">
