                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-table"></i> Product Management Page</div>
                            <div class="card-body">

                                <div id="productManagementPageHolder">

                                    <div id="productManagementPageMainDiv">
                                    </div>
                                    <div class="table-responsive" id="productManagementPageTableDiv">
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#productManagementPageMainDiv').load('productManagementPageMain.php');
