                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-users"></i>  Product Sales Page (Quantity) 
                            </div>
                            <div class="card-body">

                                <div id="dataAnalysisProductSalesManagementPageQuantity">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataAnalysisProductSalesManagementPageQuantity').load('controllerProcess/manageAnalysisProductQuantityGetData.php');
